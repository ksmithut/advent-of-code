...
const main = (args = process.argv, programRunner = program) => {
  ...
  const getConfig = args => {
    const config = {
      year: args.year,
      session: args.session || process.env.ADVENT_SESSION || userPkg.session,
      day: args.day,
      part: args.part,
  ...
  programRunner.version(pkg.version)

  programRunner.on('--help', () =>
    console.log(
      [
        '',
        '  Examples:',
